...
$sql = "select studentid, fname, lname, age,
...
//Display the list of all students in a table.
echo "<table border=1>";
echo "<tr> <th>Select for Update</th> <th>Student ID</th> <th>First Name</th>
...
while (OCIFetchInto ($cursor, $values)){
  ...
  "action=\"update_student.php?sessionid=$sessionid&studentflag=$studentflag&adminflag=$adminflag&studentid=$studentid\" " .
  "value=\"Update\"></td>
